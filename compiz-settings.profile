...
s0_open_durations = 175;250;170;170;
s0_open_matches = class=Guake.py;((type=Normal | Unknown) | name=sun-awt-X11-XFramePeer | name=sun-awt-X11-XDialogPeer) & !(role=toolTipTip | role=qtooltip_label) & !(type=Normal & override_redirect=1) & !(name=gnome-screensaver);(type=Menu | PopupMenu | DropdownMenu | Combo | Dialog | ModalDialog);(type=Tooltip | Notification | Utility) & !(name=compiz) & !(title=notify-osd);
s0_open_options = ;;;;
s0_open_random_effects = 
s0_close_effects = animation:Fade;animation:Glide 2;animation:Fade;animation:Fade;
s0_close_durations = 175;250;170;170;
s0_close_matches = class=Guake.py;((type=Normal | Unknown) | name=sun-awt-X11-XFramePeer | name=sun-awt-X11-XDialogPeer) & !(role=toolTipTip | role=qtooltip_label) & !(type=Normal & override_redirect=1) & !(name=gnome-screensaver) & !(name=gnome-screenshot);(type=Menu | PopupMenu | DropdownMenu | Combo | Dialog | ModalDialog | Normal);(type=Tooltip | Notification | Utility) & !(name=compiz) & !(title=notify-osd);
s0_close_options = ;;;;
...
s0_border_color = #0067fb9f
s0_fill_color = #0062fb19
s0_normal_match = 
s0_outline_match = 
s0_rectangle_match = 
s0_stretch_match = 
...
s0_left_edge_threshold = 1
s0_right_edge_threshold = 2
s0_top_edge_threshold = 1
s0_bottom_edge_threshold = 1
s0_draw_indicator = true
s0_outline_color = #00a2fb9f
s0_fill_color = #0082fb4f
...
[mag]
s0_initiate = <Shift><Alt>m
s0_zoom_in_button = <Shift><Super>Button3
s0_zoom_out_button = <Shift><Super>Button1
s0_mode = 0
...
s0_show_expo_icon = true
s0_menus_fadein = 150
s0_menus_fadeout = 150
...
[ezoom]
s0_zoom_in_button = <Shift><Control><Primary>Button3
s0_zoom_in_key = Disabled
s0_zoom_out_button = <Shift><Control><Primary>Button1
...
s0_no_close_match = 
s0_no_focus_match = 
s0_size_matches = class=Guake.py;
s0_size_width_values = 1318;
s0_size_height_values = 350;
...
[core]
s0_active_plugins = core;composite;opengl;compiztoolbox;decor;vpswitch;gnomecompat;resize;grid;move;mousepoll;regex;place;imgpng;commands;session;wall;winrules;animation;wobbly;expo;fade;workarounds;scale;scaleaddon;unityshell;
